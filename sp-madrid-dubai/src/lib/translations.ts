...
export const en: Translations = {
  ...
  hero_heading1:  'Eighteen Years of Trust.',
  ...
  timeline_eyebrow: '18 Years of Excellence',
  timeline_title:   'From the Philippines to the United Arab Emirates',
  timeline_sub:     'An 18-year journey in debt recovery and receivables management across Southeast Asia and the UAE.',

  tl_2004_title: 'Founded in the Philippines',
  tl_2004_desc:  'S.P. Madrid established in Makati CBD in 2008 with 12 professionals and a mission to redefine ethical collections in the Philippines.',
  tl_2007_title: 'Bank Partnership Begins',
  tl_2007_desc:  'Started major banking partnership recognition with BPI, laying the foundation for long-term institutional recovery services.',
  ...
  proof_det_years:        'Founded 2008, Manila',

  adv_eyebrow: 'The Philippine Advantage',
  adv_title:   'Why Our Roots Make Us Stronger',
  adv_sub:     'Eighteen years of excellence in Manila built the operational foundation that makes SPM Dubai a trusted recovery partner in the Gulf.',
...
export const ar: Translations = {
  ...
  hero_heading1:  'ثمانية عشر عامًا من الثقة.',
  ...
  timeline_eyebrow: '18 عامًا من التميّز',
  timeline_title:   'من الفلبين إلى الإمارات العربية المتحدة',
  timeline_sub:     'رحلة تمتد 18 عامًا في إدارة المستحقات وتسوية الديون عبر جنوب شرق آسيا والإمارات.',
  ...
  proof_det_years:        'تأسست 2008، مانيلا',

  adv_eyebrow: 'الميزة الفلبينية',
  adv_title:   'لماذا تجعلنا جذورنا أقوى',
  adv_sub:     'ثمانية عشر عامًا من التميّز في مانيلا أرست الأساس التشغيلي الذي يجعل SPM دبي شريكًا موثوقًا في الاسترداد بمنطقة الخليج.',
